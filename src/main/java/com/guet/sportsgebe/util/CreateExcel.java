...
public class CreateExcel {
     ...
     * @return
     */
    public static List<Map<String, Object>> createExcelRecord(
            List<ActUser> actUsers) {
        List<Map<String, Object>> listmap = new ArrayList<Map<String, Object>>();
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("sheetName", "sheet1");
        listmap.add(map);
        for (ActUser temp : actUsers) {
//            "id", "actId", "enlistTime", "amountPaid", "attendState", "isLeader"

            Map<String, Object> mapValue = new HashMap<String, Object>();
            mapValue.put("id", temp.getUserid());
            mapValue.put("actId", temp.getActid());
            mapValue.put("enlistTime", temp.getEnlisttime());
            mapValue.put("amountPaid", temp.getAmountpaid());
            mapValue.put("attendState", temp.getAttendstate());
            mapValue.put("isLeader",temp.getIsleader());
